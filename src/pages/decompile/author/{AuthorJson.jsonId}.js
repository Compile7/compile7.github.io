                ...
                <ul>
                  {github && (
                    <li>
                      ...
                      >
                        <svg
                          aria-labelledby="svg-inline--fa-title-j5vmwMLh8lLF"
                          data-prefix="fab"
                          data-icon="github"
                          ...
                          viewBox="0 0 496 512"
                        >
                          <title id="svg-inline--fa-title-j5vmwMLh8lLF">
                            Github
                          </title>
                          <path
                            fill="currentColor"
                  ...
                  {stackoverflow && (
                    <li>
                      ...
                      >
                        <svg
                          aria-labelledby="svg-inline--fa-title-Ikgo3VsqFhwJ"
                          data-prefix="fab"
                          ...
                          viewBox="0 0 384 512"
                        >
                          <title id="svg-inline--fa-title-Ikgo3VsqFhwJ">
                            StackOverflow
                          </title>
                          <path
                            fill="currentColor"
                  ...
                  {linkedin && (
                    <li>
                      ...
                      >
                        <svg
                          aria-labelledby="svg-inline--fa-title-TPBXLyEt14R0"
                          data-prefix="fab"
                          data-icon="linkedin"
                          ...
                          viewBox="0 0 448 512"
                        >
                          <title id="svg-inline--fa-title-TPBXLyEt14R0">
                            Linkedin
                          </title>
                          <path
                            fill="currentColor"
                  ...
                  {twitter && (
                    <li>
                      ...
                      >
                        <svg
                          aria-labelledby="svg-inline--fa-title-yoaMTuWucsCF"
                          data-prefix="fab"
                          data-icon="twitter"
                          ...
                          viewBox="0 0 512 512"
                        >
                          <title id="svg-inline--fa-title-yoaMTuWucsCF">
                            Twitter
                          </title>
                          <path
                            fill="currentColor"
