...
const AboutUs = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>
        Compile7 Blog is a place for developers to learn from and contribute to.<br/>
      ...
      <p>
        ...
        any way you want that adds value :) <br/>

        To make collaborations and contributions easier, we manage Compile7 Blog on GitHub as an open
        source project.<br/>
        
        Ready to contribute? Have a look at{" "}
      ...
      <p>
        We understand you. It’s a fair question! <br/>
        
        You may ask, “there are many platforms like Medium and Dev.to — or even my personal blog — where I
        can publish my blog posts. Why Compile7 Blog?” <br/>
        
        At the core, developers develop and build things. While some developers are regular writers,
        some maybe just start out or need some editorial help to get going. This
        is where we come in. <br/>
        
        When you want to write for Compile7 Blog, we help
      ...
      <p>
        ...
        <a href="https://github.com/Compile7/compile7.github.io/discussions"> 
